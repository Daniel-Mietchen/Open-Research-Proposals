...
One consequence of this ubiquitous practice is that while science knowledge within a research group grows in small continuous incremental steps, the community outside the research group does not gain access to that knowledge until the process is completed. 
A second consequence is that, unaware of the existance of those intermediate steps, research groups end up duplicating work in parallel. 
A third consequence is that data that is generated that may not be justifiably included in a scientific report (because it does not contribute to the overall 'story') does not get published and remains unknown to the wider community. 



Research publishing is the business of providing high-resolution snapshots of these
steadily evolving boundaries. 
