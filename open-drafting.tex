...
\begin{document}
\title{Drafting proposals in the open - the actual draft document}
...
This file serves to familiarize ourselves with using GitHub as a collaborative environment for drafting a project proposal, 
...
It was started by pasting below the leftovers from the 
...
We then turned this into LaTeX format and plan to continue drafting that way~-- please excuse any strange formatting you may see in here until about May 20, 2011.
...
::'''I would kill everything below this''' Fabiana Kubke 14:24, 3 May 2011 (CEST)

*Mention Workshop 2 (May 10, "Which funding bodies are there that can give financial support, and how do we find appropriate sponsors for our project?") and the \href{http://en.wikiversity.org/wiki/User:OpenScientist/P2PU_course_2011/Workshop_2 Wikiversity page used to draft the corresponding blog post}.
