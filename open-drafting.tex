...
\begin{frontmatter}
	\title{{\LARGE \bf Committed to Science}\\-- Minimizing the path through the literature~--\\ A  \href{http://en.wikiversity.org/wiki/User:OpenScientist/Open_grant_writing_-_Encyclopaedia_of_original_research}{DRAFT} for a grant proposal,\\ written by}
	...
	\begin{abstract}
		...
		\begin{itemize}
			...
			\item {\bf Submission of the proposal is anticipated for the end of August, 2011}.
...
\newpage
	\begin{quote}
		\begin{center}
			``There should be only one repository of art in the world, to which the artist would donate his works to take what he would need''~--~~\href{http://books.google.com/books?id=Fyg9AAAAcAAJ&pg=PA31&dq=beethoven+\%22Es+sollte+nur+ein+Magazin+der+Kunst+in+der+Welt+sein\%22&hl=en&ei=S8wSTr_TOovA8QOW15m6Dg&sa=X&oi=book_result&ct=result&resnum=1&ved=0CCsQ6AEwAA#v=onepage&q=beethoven\%20\%22Es\%20sollte\%20nur\%20ein\%20Magazin\%20der\%20Kunst\%20in\%20der\%20Welt\%20sein\%22&f=false}{Beethoven}
			%``Es sollte nur ein Magazin der Kunst in der Welt sein, wo der K{\"u}nstler seine Werke nur 
			% hinzugeben h{\"a}tte, um zu nehmen, was er brauchte;
			% so muss man noch ein halber Handelsmann dabei sein!'''~--\href{http://books.google.com/books?id=Fyg9AAAAcAAJ&pg=PA31&dq=beethoven+%22Es+sollte+nur+ein+Magazin+der+Kunst+in+der+Welt+sein%22&hl=en&ei=S8wSTr_TOovA8QOW15m6Dg&sa=X&oi=book_result&ct=result&resnum=1&ved=0CCsQ6AEwAA#v=onepage&q=beethoven%20%22Es%20sollte%20nur%20ein%20Magazin%20der%20Kunst%20in%20der%20Welt%20sein%22&f=false}{Beethoven}
		\end{center}
	\end{quote}
...
\newpage
\section{To do}
{\it This section will be deleted when drafting is finished.}
\begin{itemize}
	\item Shorten the paragraphs in section \ref{section:intro} and merge it with section \ref{section:intro2}.
	\item Think of potential contributions to the July 16 \href{http://bca.geek.nz/}{Barcamp Auckland}
	\item By mid-July: Think about potential projects for \href{https://wiki.auckland.ac.nz/display/eResearchNZ/Summer+of+eResearch+2011+-+2012}{Summer of eResearch NZ} (perhaps for testing the EoR prototype)
	\item before August 5: submit project to \href{http://royalsociety.org/policy/sape/}{'Science as a public enterprise' study of the Royal society}
	\item before August 31: submit project to \href{http://challenge.gov/NIH/132-nlm-show-off-your-apps-innovative-uses-of-nlm-information}{NIH reuse app challenge}
...
{\it This section is to be merged into section \ref{section:intro2}}.
...
%According to I think Guedon's article (will check) there was some type of peer review even prior to the Phil Trans, and I can
% look up the year when the peer review started (mainly by editors and close relatives). The 'massive' peer review as we know
% it (I think he says) started withe the type writer when you could easily carbon copy several copies of the document to send
% out. 
...
%PBRF?
%Performance Based Research Funding - the govt looks at how good we are and then decides how much money they give the
%University. There is (or was) a similar system in the UK 
...
%I think I qualify
% You've _never_ uttered words to that effect????
...
%Note: In the Thompson Reuter workshop, they stressed how citations are not a good measure: Eg, when I talk about Calcium
% binding proteins today, I cite a review (not the original work that described them) The review cites that article, and 
%it 'steals' the citations from the original work. At the workshop they suggested that you need to track at least to 3rd 
%order citations to really measure value - the most valuable work ends up being indirectly cited through reviews but 
%the original gets lost and no one reads it again, but without it, the field would have never started. 
...
\begin{quote}
		``Change the way scientists are evaluated.''~--the most important action item in Open Science, according to a 
	\href{http://lists.okfn.org/pipermail/open-science/2011-July/000840.html}{vote} of participants at the \href{http://indico.cern.ch/contributionDisplay.py?contribId=26&confId=103325}{Open Science Workshop} at \href{http://indico.cern.ch/conferenceDisplay.py?ovw=True&confId=103325}{OAI7}	
\end{quote}
...
%When I was going through google scholar trying to find the paper of hte students that challenged the Kandel paper, I went through several pages without finding it - eventually had to find it in a different way - 
...
\subsection{Identifying gaps in knowledge}

\subsection{Notes}

\begin{itemize}
	\item record research as it happens (\href{http://en.wikiversity.org/wiki/User:OpenScientist/ESOF_2012/Science_as_it_happens}{ESOF workshop})
	\item review how it happened
	\item review the interpretation of research results in the context of existing knowledge
	\item identify gaps in knowledge, infrastructure or methodology
	\item stimulate further research
	\item stimulate public engagement
	\item deliver useful outcomes to local and global communities
	\item \href{http://twitter.com/EvoMRI/statuses/2316110674}{share}
\end{itemize}
...
\paragraph{Notes}
Room for "fishing expeditions" (data-driven research not directed at particular hypotheses; cf. \href{http://dx.doi.org/10.1091/mbc.E09}{\citet{botstein2010d}}) in addition to hypothesis-driven research
...
\begin{itemize}
	...
	\item somewhat similar functionality on Sugar: \href{http://activities.sugarlabs.org/en-US/sugar/addon/4042}{Info Slicer}. See also \href{http://lists.laptop.org/pipermail/grassroots/2011-June/001781.html}{Make your Own Sugar Activities} handbook (CC-BY-SA).
...
Estimating about 60K articles available as 'libre' - (about 4% of what is being published has libre licences) the project is seeded with about 200,000 pages (or in context less than 10% of wikipedia). 
\section{Budget}
...
%These notes mostly originated \href{http://species-id.net/wiki/Draft:Encyclopaedia_of_original_research}{on the wiki} 
%and will be woven into the proposal or discarded during the drafting process.
...
@scann Ah, I see - I was thinking about that earlier today - how do I phrase this to say "as a first step we will do this in this area" - I thought concentrating on one specific (I was thinking Chagas would be a good candidate - I am more familiar with some implications)
	...
	\item \href{http://friendfeed.com/oatp/ffa8e3c0/funding-for-sustainability-how-funders}{How Funders’ Practices Inﬂuence the Future of Digital Resource}
	\item \href{http://doc.liquidizer.org/}{Liquidizer - non-linear version control} (\href{https://github.com/liquidizer}{on GitHub})
	\item \href{https://www.bestgrid.org/collaboration/sakai}{Sakai on BeSTGRID}
	\item \href{https://wiki.auckland.ac.nz/display/eResearchNZ/Summer+of+eResearch+2011+-+2012}{Summer of eResearch NZ}
	\item \href{http://dx.doi.org/10.1126/science.1157784}{Strategic Reading, Ontologies, and the Future of Scientific Publishing}~-- mentioned in Geoffrey Bilder's talk at e-publishing: expresses great enthusiasm for web-based science
	\item \href{http://www.technologyreview.com/blog/mimssbits/26960/}{By 2014, all of South Korea's elementary-level educational materials will be digitized, and by 2015, the entire school-age curriculum will be delivered on an array of computers, smart phones and tablets.}
	\item \href{http://www.biomedcentral.com/1471-2105/10/291}{Automated seeding of specialised wiki knowledgebases with BioKb}
	\item \href{http://dx.doi.org/10.1371/journal.pctr.0010006}{Long ago Ian Roberts and I imagined a world in which studies would not be published in journals but rather in databases. The job of journals would not be to spend resources peer reviewing and circulating studies to people who don’t read them but rather to pick out the few studies that matter and present critical appraisals of them to the right audience. Perhaps the proliferation of copies of PLoS ONE will bring that vision closer.} - combine this with "So, we had the idea that you do your systematic review before you do your research; you do your research, and then if you haven't changed much, you haven't really made a big impact, whereas if you've actually shifted things one way or the other and made it more precise then you have." (E. Wagner)
	\item In principle, scientific knowledge can only grow. However, there are a number of scenarios in which  
	information already out there may not make it into the knowledge base of future generations:
	\begin{itemize}
		\item An inefficient communication system, which prevented Gregor Mendel's work on inheritance to be picked up in time.
		\item Censorship, which prevented the knowledge accumulated by people like Galileo to spread
	\item Deliberate obfuscation: Galileo also hid information by way of anagrams (\href{http://www.webcitation.org/60El1s9zf}{``Haec immatura a me iam frustra leguntur o.y.''}; nowadays, patents use \href{www1.american.edu/cas/econ/faculty/park/usitc.pdf}{more sophisticated techniques}
		\item Technological progress: Knowledge about stone tools is not widely spread amongst the general population nowadays, although it was a million years ago. For a more recent example, think of floppy disks or TELEX.
		\item Scientific progress: Knowledge about the concept of the ether as a medium to mediate forces between distant bodies became obsolete with (the acceptance of) Einstein's theory of special relativity.
		\item disaster (Library of Alexandria), statues on Easter Islands
		\item combinations~-- if the work by Aristarchos of Samos on heliocentricism would have been more widely known, Galileo's fights with the inquisition would have taken another course
	\end{itemize}
	\item \href{http://pkp.sfu.ca/ocs/pkp/index.php/pkp2011/pkp2011/paper/view/259}{Threaded publications at BMC}
	\item \href{http://www.k4all.ca/}{Knowledge for All} ``is an open access and open source citation database of all published scholarly journal literature that is being developed by the global library community, led by the University of Prince Edward Island with the support of the Council of Atlantic University Libraries. It will provide researchers with a single tool to search across all disciplines and the general public with free access to scholarly citations. Thousands of libraries around the world will share project costs and content creation, thereby contributing staff expertise and saving thousands of dollars on database subscriptions. Knowledge for All will be an open source, customizable tool with robust search features that will give institutions control over their content and technology.''
	\item \href{http://blog.hipchat.com/2010/10/15/github-is-making-me-lazy-but-i-like-it/}{modified quote: ``The standardized X and Y features mean that many projects are set up in the same way. Once you learn how to contribute to one project on A, you know how to commit to all of them. [..] It feels a lot harder to contribute to non-A projects because it often requires signing up for their custom procedures, and waiting longer before the patch is accepted. That extra friction is sometimes enough to prevent me from submitting a fix, and that’s not good for the project.''}
	\item \href{http://www.insidehighered.com/news/2011/07/19/debate_over_whether_social_web_sites_can_replace_peer_review}{``Think Wikipedia, but with original research and a specialized corps of [..] editors.''}
	\item \href{http://science.io/about}{Reddit for science}
	\item \href{http://bit.ly/nmKQju}{``If the transformation is to be purposeful, then it will need
general oversight, discipline-specific reviews, and a description of the actual and desirable
components of the 'Knowledge Organizational System' for Biology and their relationships.''}
	\item \href{http://www.biomedcentral.com/meetings/2000/foi/editorials/ginsparg}{``The figure illustrates one such possible hierarchical structuring of our research communications infrastructure. It also represents graphically the key possibility in the new electronic architecture: that of disentangling and decoupling the production and dissemination on the one hand, from the quality control and validation on the other, in a way that is not possible in the paper realm. The figure shows three electronic service layers, as viewed by the interested reader/researcher, who can choose the most auspicious access method for navigating the electronic literature. The three layers are the data, information, and knowledge networks--where information is taken to mean data plus metadata (i.e. descriptive data), and knowledge signifies information plus synthesis (i.e. additional synthesizing information).''} - also contains the point of ``suggesting a minimal path through the literature to understand a given article''
	\item \href{http://dx.doi.org/10.1080/13614576.2011.574488}{``Articles are no more than a high level derivative of the research outcomes'' (Jim Gray)}~-- see also Hey et al. 2009 and Collins’ review [2010] as cited by Smit \& Gr{\u"}ttemeier 2011
	\item \href{http://portal.acm.org/citation.cfm?id=1321449}{``we view Wikipedia simply as a first bootstrapping step,
which will enable subsequent extraction from the Web as a whole''}
	\item \href{http://oro.open.ac.uk/23344/}{ClaiMaker: weaving a semantic web of research papers} (2002)
	\item \href{http://okcon.org/2011/programme/reinvention-for-sustainability}{``around 1\% of reported inventions are reinventions''}
...
\begin{itemize}
	...
	\item \href{http://www.sloan.org/}{Sloan Foundation} (co-funder of \href{http://www.eol.org/}{Encyclopedia of Life} and \href{http://en.wikipedia.org/wiki/Wikipedia:Wikipedia_Signpost/2011-07-11/News_and_notes}{Wikimedia})
	...
	\item \href{http://www.qf.org.qa/}{Qatar Foundation}? See also their \href{http://www.ameinfo.com/269578.html}{recently launched} \href{http://www.qscience.com/}{OA journal, QScience Connect}
	\item \href{http://www.jisc.ac.uk}{JISC}~-- they have a Digital Infrastructures Team (see \href{http://lists.okfn.org/pipermail/open-science/2011-July/000840.html}{this message on OAI7}); see also the \href{http://www.jisc.ac.uk/events/2011/03/jisc11/programme.aspx}{JISC Conference 2011}
\end{itemize}
