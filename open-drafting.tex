...
%What about doing away with listing single authors, and choosing a group alies
	...
	\begin{abstract}
		\begin{itemize}
			\item This file serves the collaborative drafting of a project proposal on an {\bf Encyclopaedia of (and GitHub for) science}, 	as explained in \href{http://www.science3point0.com/evomri/2011/05/03/drafting-proposals-in-the-open-sketching-out-project-ideas/}{this blog post}. 
			...
			\item We then turned this into LaTeX format and plan to continue drafting that way~-- please excuse any strange formatting you may see in here until late May 20, 2011.

			\item Unless something is clearly marked as being imported from elsewhere, all of this text is licensed CC0/Public Domain, while the \LaTeX code is available under the \href{http://www.latex-project.org/lppl.txt }{LaTeX license}, with the origin being the \href{http://www.elsevier.com/wps/find/authorsview.authors/elsarticle}{Elsevier article bundle}. 
			
			\item Comments {\bf very} welcome, preferably via \href{http://en.wikiversity.org/wiki/User:OpenScientist/Open_grant_writing_-_Encyclopaedia_of_original_research}{our project's homepage}.
	...
	\begin{keyword}
		Science as a wiki \sep GitHub for science \sep open access \sep Creative Commons
...
\subsubsection{Scientific publishing}
...
\subsection{Sustainability of the project}
...
*\href{https://en.bitcoin.it/wiki/Introduction#Preventing_double-spending}{Bitcoin}
*\href{http://www.ccc.de/en/updates/2011/kulturwertmark}{KulturWertMark}
*FigShare as virtual museum?
*\href{http://ff.im/D6rQ0}{Discussion of Gantt chart tools}
*]\href{http://dx.doi.org/10.1038/npre.2010.4603.1}{Community building in ecology}
