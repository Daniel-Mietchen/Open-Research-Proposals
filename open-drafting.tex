...
% mention \href{http://laptop.org}{One Laptop Per Child  project} (OLPC) somewhere
%add figure showing XO ?

\begin{figure}[!h]
	\begin{center}
		%http://wiki.laptop.org/go/File:Bucolico-full.jpg
...
%mention OLPC needs Khan Academy
