...
\begin{figure}[!ht]
	\begin{center}
		...
		\caption{
		{\bf Redundancy in journal articles.} Wordle from three articles (Kr{\"u}tzfeldt et al 2010a, b and Wild et al 2010) showing the occurrence of individual words in the introduction and discussion sections
		}
		\label{Figure:Wordle}
	\end{center}
\end{figure}
...
%An image (which?) of the research cyle should come somewhere near here.
